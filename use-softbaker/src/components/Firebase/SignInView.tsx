...
const SignInView: React.FC<SignView> = ({ onAuthDone, setUser, config, ...props }) => {
    ...
    const sendRequest = (maxRetries: number, triedTimes: number) => {
      ...
      .then((userCredential) => {
        ...
        if(userCredential) {
          ...
          if(onAuthDone) onAuthDone(userCredential.user)
        }
      })
      .catch((e) => {
        let msg
    ...
    return (
        <VStack>
            ...
            <Text as="div" alignSelf="flex-end">
