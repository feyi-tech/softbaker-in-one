...
import { Box, Divider, Flex, HStack, Image, Tab, TabList, TabPanel, TabPanels, Tabs, VStack } from "@chakra-ui/react"
import { COINS, IS_TEST, LOGO_PATH, PRECISION, SDK_NAME } from '../../utils/c'
...
import { getColor, getDefaultCoin } from '../../utils/f'
...
const PayFlow: React.FC<PayFlow> = ({ 
    show, payAmount, walletListenerResult, priceData, vendors, minDeposit, minVendorDeposit, 
    onSuccess, onClose, isDarkMode, contactLink, config
}) => {
    ...
    return (
        <Box
            ...
            bottom="0"
            w="100%" h="100%"
            bg={getColor(isDarkMode, "overlayBg")}
            zIndex="1500" 
            display="flex" 
        ...
        >
            <Flex flexDir="column" pos="relative" w="100%" h="100%" justifyContent="center" alignItems="center">
                ...
                <Box w="100%" maxW={{base: "100%", md: "400px"}} h={{base: "100%", md: "auto"}}
                  m="0 auto" bg={getColor(isDarkMode, "cardBg")} borderRadius={{base: "0px", md: "8px"}} pb={{base: "0px"}}
                boxShadow={{base: "none", md: `0px 0px 10px ${getColor(isDarkMode, "cardBgShadow")}`}} pos="relative" 
                pt={{base: "0.5rem", md: "0px"}} overflowY="auto" overflowX="hidden">
                    ...
                    <Divider mx="0px !important" mb={2} />
                    {
                        ...
                        <VStack w="100%" h="68vh" justifyContent="center" alignItems="center">
                            <PleaseWaitForX />
                        </VStack>
                        :
                        editAmount?
                        <AmountEditor vendors={vendors} amount={amount} minAmount={minDeposit} onAmountValid={(amount) => {
                            setAmount(amount)
                        }} onSubmit={() => {
                            setEditAmount(false)
                        }} />
