...
const CryptoDeposit: React.FC<CryptoDeposit> = ({ 
    amount, coin, setCoin, coinAmount, coinSymbol, isDarkMode,
    wallet, setWallet,
    ...
    return (
        <Box px={{base: "8px", md: "32px"}} minH="250px" {...props}>
            <Flex direction="column" alignItems="center" justifyContent="center">
                <Text as="div" mb={1} textAlign="center" fontSize="12px !important">Scan the QR code or copy the wallet address to deposit:</Text>
                <Box mb={1}>
                ...
                <HStack w="100%" justifyContent="center" alignItems="center" mb={1}>
                    <Text as="div" p="0px" fontSize="12px !important" textAlign="center">To deposit <b>${amount.toFixed(2)}</b>, transfer <CopyView as="span" fontWeight="bold" display="inline" p="0px !important" m="0px !important" color="green" borderBottom="1px dotted" cursor="pointer" textToCopy={`${coinAmount}`} onCopyMessage="Amount copied.">{coinAmount} {coinSymbol}</CopyView> to the wallet address shown.</Text>
                </HStack>
                ...
                <>
                {
                    ...
                    <Box cursor="pointer" mb={2} pos="relative" w="100%" border="1px solid #e2e8f0" borderRadius="0.5rem" 
                        ...
                        borderTopRightRadius="0.5rem" borderBottomRightRadius="0.5rem">
                ...
                <Box pos="relative" mb={2} w="100%">
                    ...
                    <Select bg={getColor(isDarkMode, "selectCoinBg")} id="select-coin" cursor="pointer" onChange={(c: any) => {
                ...
                <HStack pos="relative" w="100%" px="5px" mb="0.5rem" border="1px solid #e2e8f0" 
                borderRadius="0.5rem" 
                bg={getColor(isDarkMode, "transferWarningBg")}>
                    <Box>
