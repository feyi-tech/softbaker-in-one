        ...
        <Box w="100%" h="100vh" dir={isRTL? 'rtl' : 'ltr'} overflow="hidden">
            ...
            >
                ...
                display={{
                    ...
                    lg: sideBarMenu.length > 0? "flex" : "none"
                }} 
                flexDirection={{base: mobileShowSideBarAsBottomNav? "row" : "column", lg: "row"}}
                justifyContent="flex-start" alignItems="center">
                        
                    <Box display={{base: mobileShowSideBarAsBottomNav? "none" : "block", lg: "block"}} 
                    px="20px">
                        {sidebarHeader}
                    </Box>
                ...
                <Box as="main" w="100%" pos="relative" overflowX="hidden" h="100vh" overflow="hidden">
                    ...
                    justifyContent="space-between" alignItems="center">
                        ...
                        <HStack justifyContent="flex-start" alignItems="center">
                            ...
                            display={{base: "none", lg: sideBarMenu.length > 0? "block" : "none"}} 
                            cursor="pointer" 
