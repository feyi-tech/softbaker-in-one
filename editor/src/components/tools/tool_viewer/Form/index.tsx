...
import FieldsInput from '../../tool_editor/Form/svg-processor/FieldsInput';
import SvgRenderer from '../../tool_editor/Form/svg-processor/SvgRenderer';
...
import useFonts from '../../tool_editor/Form/svg-processor/hooks/use-fonts';
import useDefaultFieldsValue from '../../tool_editor/Form/svg-processor/hooks/use-default-fields-value';
...
const Form: React.FC<FormType> = ({
    ...
    const { user, sdkConfig } = useFrontbacked()
    ...
    const handleSubmit = async () => {
        if(!onPublishData || !saveTemplate || !selectedTemplate) return
        setSaving(true)
