...
import { ACCOUNT_TYPES, GENDER, MARITAL_STATUS, PROCESSING_DURATION } from "./Form/doc-data"
...
export const getDefaultData = () => {
  ...
  const defaultData = {
      ...
      accountType: Object.keys(ACCOUNT_TYPES)[0],
      gender: Object.keys(GENDER)[0],
      maritalStatus: Object.keys(MARITAL_STATUS)[0],
      currencySymbol: "US_USD_$",
      ...
      is_freemium: true,
      accountBalance: 0,
      disableAccountError: "Your account is currently on hold. Please go to our nearest branch to resolve the issue on your account.",
      noTxGeneration: true,
      txProcessingDuration: Object.keys(PROCESSING_DURATION)[0],
      isInActive: false
  } as Data
