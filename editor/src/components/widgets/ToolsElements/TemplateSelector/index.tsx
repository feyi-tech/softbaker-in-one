...
import { Template as TemplateProps, Templates } from "frontbacked-svg";
    ...
    return (
        <HStack cursor="pointer" justifyContent="space-between" alignItems="flex-end" mb={1} mx="0.5rem" {...props}>
            <HStack justifyContent="flex-start" alignItems="flex-end">
                <Image src={logo || "/res/svg-icon.png"} w="35px" h="35px" borderRadius="5px" border="1px solid #dfdfdf" />
        ...
        <Box {...props}>
          <FormControl opacity={disabled? 0.4 : 1} cursor={disabled? "not-allowed" : "pointer"}>
              ...
              <HStack className="image-selector-button" onClick={(e: any) => { 
                  ...
                  { template? <Image src={template.logo || "/res/svg-icon.png"} w="35px" h="35px" borderRadius="5px" border="1px solid #dfdfdf" /> : null }
