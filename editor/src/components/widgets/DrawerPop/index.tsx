...
import { 
    ...
    DrawerHeader, DrawerOverlay, Text, useBreakpoint, useBreakpointValue 
} from "@chakra-ui/react"
import { FaTimes } from "react-icons/fa"
import { isVoid } from '@/root/src/utils/f'
...
const DrawerPop: React.FC<DrawerPop> = ({
    bg, 
    color, 
    children, 
    placement, 
    ...
    placement = useBreakpointValue(typeof placement === "string"? {base: placement} : placement)
    useEffect(() => {
    ...
    return (
        <Drawer placement={placement} 
            ...
            <DrawerOverlay />
                <DrawerContent bg={bg || useColorValue("cardBg.light", "cardBg.dark")} color={color} 
