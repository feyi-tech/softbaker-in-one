...
import { useTools, DynamicTool, StaticTool } from 'use-frontbacked';
import Card from '../Card';
import { USE_FRONTBACKED_CONFIG } from '@/root/src/app-config';
...
const Tutorial: React.FC<Tutorial> = ({ show, currentToolId, onClose }) => {
  ...
  const { toolsById } = useTools(USE_FRONTBACKED_CONFIG)
