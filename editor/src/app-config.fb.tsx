import { Tool as ToolProps } from "use-frontbacked/dist/components/types"
...
export const PAYSTACK_PK = "pk_live_fcd88ba9ea92d6896c751ba18028afc9c42b2fb6"

export const ALPHABETS = "abcdefghjkmnpqrstvwxyz".split("")
export const IPFS_VIDEO_FOLDER = "hAttps://cloudflare-ipfs.com/ipfs/QmcYwiCg8dNBWBjA6ciPVBCMBRzjTpfsWCs94PuJXhN3tu/"
...
export const TELEGRAM_COLOR = "#24A1DE"
export const WHATSAPP_COLOR = "#075E54"
export const APP_DOMAIN = "frontbacked.com"
export const R2_DOMAIN = "r2.frontbacked.com"
export const SITE_ID = "cargo"
export const URL_BASE = "https://frontbacked.com"
export const APP_NAME = "FrontBacked"
export const APP_DESCRIPTION = "Generate Websites for content creation and to shoot realistic website operations in your movie scenes."
...
export const FIREBASE_FUNCTION_API_BASE_URL = "https://us-central1-paybulous.cloudfunctions.net/api"

export const IMGLY_BG_REMOVAL_ASSETS_PATH = `https://${R2_DOMAIN}/assets/imgly-background-removal/`

export const USE_FRONTBACKED_CONFIG = {
