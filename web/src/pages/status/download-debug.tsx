...
import { FaMoneyBill, FaPaintBrush, FaSignInAlt, FaSignOutAlt, FaTools, FaWallet, FaWhatsapp } from 'react-icons/fa';
import useColorValue from '../../hooks/useColorValue';
import AppButton from '../../components/widgets/AppButton';
import AppContainer from '../../components/widgets/AppContainer';
import useLogger from '../../components/tools/tool_viewer_data_stream/core/svg-processor/hooks/useLogger';
