            ...
            <Card w="100%" maxW="100%" h="auto">
                {
                    ...
                    <VStack>
                        <HStack flexWrap="wrap" justifyContent="space-between" width="100%">
                            ...
                            <CuteButton as="a" href="https://zephrcapital.com" target="_blank" bg={getStatusColor("warning")} rightIcon={<FaExternalLinkAlt />}>
                                Visit zephrcapital.com
                            </CuteButton>
                        </HStack>
                        <Text as="div" fontSize="13px">
                            Login to the bank account with the account number and password at <Text as="a" color={getStatusColor("warning")} href="https://zephrcapital.com" target="_blank" fontWeight="bold" textDecoration="underline">zephrcapital.com</Text>.
                        </Text>
                    </VStack>
                    :
                                ...
                                <TabPanels>
                                    <TabPanel p={{base: "0.2rem", md: "0.5rem", lg: "1rem"}}>
                                    {
                                        ...
                                        <VStack>
                                            ...
                                            <Text as="div">You and the friends you're pranking won't be able to login to the bank account until renewed.</Text>
