...
import { Doc, FontsMap, cleanFilename, generateFontMap, getFontFamiliesFromSVG, nullOrEmpty } from "softbaker-svg"
        ...
        return new Promise(async (resolve, reject) => {
            if(!fonts) {
                ...
                if(uploadRquestsData.length > 0) {
                    ...
                    uploadFilesToR2(user, uploadRquestsData, "https://r2.softbaker.com/")
