...
const AppButton: React.FC<AppButtonProps> = ({as, onClick, children, variant, bgColor, outlineColor, leftIcon, rightIcon, loading, disabled, ...props}) => {
    const bg = bgColor || useColorModeValue('colorAccent.light', 'colorAccent.dark')
    const outline = outlineColor || useColorModeValue("colorAccentDestination.light", "colorAccentDestination.dark")
